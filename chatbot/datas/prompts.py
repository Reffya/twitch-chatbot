class LLM_PROMPTS:
    ...
    WHYISUCK = {
        ...
        "themes" : ["mécaniques de jeu", "vision de jeu", "attention à la carte", "connaissance des personnages", "choix des objets", "flexibilité dans les rôles", "positionnement pendant les combats", "farm" , "communication" , "teamfights"],
        "max_new_tokens" : 150
    }
    NAMEPOETRY = {
    ...
    NAMELORE = {
        "context" : "La commande !namepoetry permet de générer un petit poème autour du nom de l'utilisateur",
        "text" : "Le nom {user} trouve son origine dans {theme}.",
        "themes" : ["l'egypte antique", "la chine antique", "l'empire perse", "l'Angleterre médiévale", "la Mongolie", "la France sous Charlemagne", "l'empire Romain", "la Suède", "la Nubie", "le Ghana", "le Japon féodal", "l'horticulture"],
        "max_new_tokens" : 150,
    }
...
class ANNOUNCEMENT_MSG:
    ...
    MSGS = [
        ...
        "Envie de connaître les origines de ton pseudo ? Je peux t'en inventer une avec !namelore",
        "Des idées de commandes fun pour le chat ? Hésite pas à en parler à @Reffya"
    ]


class QUIZ_TEMPLATES:
    CHOSEN = "Le sujet choisi est: {subject}"
    CORRECT = "Bien joué {user}, tu as maintenant {points} points"
    END = "Et c'est {user} qui gagne le quiz !"
    CANCELLED = "Le quiz est annulé, woopsie"